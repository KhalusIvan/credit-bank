...
export default (props) => {
    ...
    return (
        <div className={`admin-review-item ${props.state}`}>
            <div className='admin-review-title'>
                ...
                <div className='review-state'>{props.state}</div>
            </div>
            ...
            <div className='admin-review-footer'>
                <div className={`review-date ${props.state ? '' : 'text-muted'}`}>{props.date}</div>
                {
                    !props.state && props.avatar !== undefined ?
