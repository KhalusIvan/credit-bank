...
export default (props) => {
    ...
    return (
        <>
            <AvsoluteBtn btnClass='sign-btn  btn-secondary pt-2 pb-2' btnText='Sigh in/Sign out' dataToggle='modal' id='signin' dataTarget='#signin' />
            <div className="modal fade signForm " id="signin" tabIndex="-1" role="dialog">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <Logo/>
                            <button type="button" className="close p-0 mt-1" data-dismiss="modal" aria-label="Close">
                        ...
                        {active === 'left' ? <SignUpForm/> : <SignInForm/>}
                    </div>
                </div>
            </div>
        </>
