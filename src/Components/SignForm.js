...
export default (props) => {
    ...
    return (
        <>
            <AvsoluteBtn btnClass='sign-btn  btn-secondary pt-2 pb-2' btnText={appLanguage === 'eng' ? 'Sigh in/Sign out' : 'Вхід / Регістрація'} dataToggle='modal' id='signin' dataTarget='#signin' />
